document.addEventListener('DOMContentLoaded', function() {
    ...
    function setupEventListeners() {
        ...
        elements.lightsaber.addEventListener('touchstart', handleClick, {passive: true});
        ...
        document.addEventListener('click', function(e) {
            ...
            if (e.target.closest('.fight-boss')) {
                const btn = e.target.closest('.fight-boss');
                const id = parseInt(btn.dataset.id);
                fightBoss(id);
            }
        });
    ...
    function renderUpgrades() {
        ...
        gameState.upgrades.forEach(upgrade => {
            ...
            upgradeEl.innerHTML = `
                ...
                <button class="buy-upgrade clickable" data-id="${upgrade.id}" ${gameState.credits < cost ? 'disabled' : ''}>
    ...
    function renderBosses() {
        ...
        gameState.bosses.forEach(boss => {
            ...
            bossEl.innerHTML = `
                ...
                <button class="fight-boss clickable" data-id="${boss.id}" ${boss.defeated ? 'disabled' : ''}>
